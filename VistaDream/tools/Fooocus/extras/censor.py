...
class Censor:
    def __init__(self):
        self.safety_checker_model: Union[ModelPatcher, None] = None
        self.clip_image_processor: Union[CLIPImageProcessor, None] = None
    ...
    def censor(self, images: Union[list, np.ndarray]) -> Union[list, np.ndarray]:
        self.init()
